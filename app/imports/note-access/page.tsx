...
import NoteAccessImportForm from "./NoteAccessImportForm";

export default function NoteAccessImportPage() {
  return (
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600">
              noteアクセス状況のスクリーンショットから記事タイトルとPVをローカルOCRで抽出し、確認後にArticleの累計PVへ反映します。
            </p>
          </div>
